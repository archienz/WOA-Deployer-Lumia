...
namespace Deployer.Lumia.Gui.ViewModels
{
    ...
    public class ScriptsViewModel : ReactiveObject, ISection, IDisposable
    {
        ...
        private readonly string extraScriptsPath = Directory.Exists(Path.Combine("Core", "Deployment-Scripts", "Lumia", "Extra"))
            ? Path.Combine("Core", "Deployment-Scripts", "Lumia", "Extra")
            : Path.Combine("Downloaded", "Deployment-Scripts", "Lumia", "Extra");
