...
{
    public class MarkdownEngine : FrameworkElement
    {
        /// <summary>
        ...
        public static readonly DependencyProperty DocumentStyleProperty =
            DependencyProperty.Register("DocumentStyle", typeof(Style), typeof(MarkdownEngine),
        ...
        public static readonly DependencyProperty Heading1StyleProperty =
            DependencyProperty.Register("Heading1Style", typeof(Style), typeof(MarkdownEngine),
                new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty Heading2StyleProperty =
            DependencyProperty.Register("Heading2Style", typeof(Style), typeof(MarkdownEngine),
                new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty Heading3StyleProperty =
            DependencyProperty.Register("Heading3Style", typeof(Style), typeof(MarkdownEngine),
                new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty Heading4StyleProperty =
            DependencyProperty.Register("Heading4Style", typeof(Style), typeof(MarkdownEngine),
                new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CodeStyleProperty =
            DependencyProperty.Register("CodeStyle", typeof(Style), typeof(MarkdownEngine), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty LinkStyleProperty =
            DependencyProperty.Register("LinkStyle", typeof(Style), typeof(MarkdownEngine), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ImageStyleProperty =
            DependencyProperty.Register("ImageStyle", typeof(Style), typeof(MarkdownEngine),
                new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty SeparatorStyleProperty =
            DependencyProperty.Register("SeparatorStyle", typeof(Style), typeof(MarkdownEngine),
                new PropertyMetadata(null));
        ...
        private static readonly Regex OutDent =
            new Regex(@"^[ ]{1," + TabWidth + @"}", RegexOptions.Multiline | RegexOptions.Compiled);

        private static readonly Regex Eoln = new Regex("\\s+");

        public static readonly DependencyProperty AssetsFolderProperty = DependencyProperty.Register(
            "AssetsFolder", typeof(string), typeof(MarkdownEngine), new PropertyMetadata(default(string)));
        ...
        {
            get => (string) GetValue(AssetsFolderProperty);
            set => SetValue(AssetsFolderProperty, value);
        }
        ...
        private Inline ImageInlineEvaluator(Match match)
        {
            ...
            {
                url = Path.Combine(AssetsFolder ?? string.Empty, url);
            }
            ...
            try
            {
                ...
                if (imgSource.IsDownloading)
                {
                    ...
                    var bindingExpression = BindingOperations.SetBinding(image, WidthProperty, binding);
        ...
        private IEnumerable<Block> DoHeaders(string text, Func<string, IEnumerable<Block>> defaultHandler)
        {
            ...
            return Evaluate(text, HeaderSetext, m => SetextHeaderEvaluator(m),
                s => Evaluate(s, HeaderAtx, m => AtxHeaderEvaluator(m), defaultHandler));
        }
        ...
        private IEnumerable<T> Evaluate<T>(string text, Regex expression, Func<Match, T> build,
